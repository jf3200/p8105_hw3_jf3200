...
the study, particularly on the weekends.No other clear trends can be
noticed from this table. The average total amount of activity on a given
day is 384543.5 and it ranged from 1440 to 685910.
...
This dataset contains information for the `rnoaa` package in R, which
contains information for the National Oceanic and Atmospheric
